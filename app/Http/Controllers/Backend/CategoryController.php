...
class CategoryController extends BackendController
{
    ...
    public function store(CategoryStoreRequest $request)
    {
        ...
        return redirect('/backend/categories')->with('message','New Category was added Successfully !');
    }
    ...
    public function update(CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect('/backend/categories')->with('message','Category has updated Successfully !');
